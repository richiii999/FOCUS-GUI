...
image = tk.PhotoImage(file="./content/testFull.png")  # Changed path to "./content/testFull.png"
...
# Image frame (for the PDF viewer) that will take up the most space
image_frame = tk.Frame(root, width=600, height=400, bg="grey")
image_frame.pack(padx=5, pady=5, side=tk.RIGHT, fill=tk.BOTH, expand=True)

# Initialize the PDF Viewer in this frame
pdf_viewer = PDFViewer(image_frame)
